...
#define INI_FILE_MAX_FILENAME_LEN 255
...
public:
	...
	bool getValue(const char* section, const char* key, std::string& str);
	bool getValue(const char* section, const char* key, int8_t& value);
	bool getValue(const char* section, const char* key, int32_t& value);
	bool getValue(const char* section, const char* key, int64_t& value);
	bool getValue(const char* section, const char* key, uint8_t& value);
	bool getValue(const char* section, const char* key, uint32_t& value);
	bool getValue(const char* section, const char* key, float& value);
	bool getValue(const char* section, const char* key, bool& value);
	//bool getValue(const char* section, const char* key, uint64_t& value);
